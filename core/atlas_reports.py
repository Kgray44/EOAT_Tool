...
def atlas_report_catalog() -> tuple[AtlasReportDefinition, ...]:
    return (
        ...
        AtlasReportDefinition("compatibility.csv", "Fit Check", "Export Fit Check Data Table CSV", "Export raw Fit Check rows for audit and filtering.", "CSV", ("Fit Check indexes",)),
        AtlasReportDefinition("compatibility.missing_eoat", "Fit Check", "Missing Validated EOAT Report", "List tools and relationships without validated EOAT links.", "CSV", ("Tool records", "EOAT links")),
        AtlasReportDefinition("compatibility.machine_coverage", "Fit Check", "Machine Coverage Report", "Summarize machines with and without EOAT/tool coverage.", "MD", ("Machine profiles",)),
        AtlasReportDefinition("compatibility.tool_coverage", "Fit Check", "Tool Coverage Report", "Summarize tool coverage and missing EOAT links.", "MD", ("Tool profiles",)),
        AtlasReportDefinition("compatibility.relationships", "Fit Check", "EOAT Relationship Report", "Summarize EOAT-machine-tool relationship health.", "MD", ("EOAT profiles", "Fit Check indexes")),

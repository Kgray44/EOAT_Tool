...
class GatewayConfiguration:
    ...
    expected_schema_revision: str = "20260714_0004"
    ...
    def from_environment(cls) -> GatewayConfiguration:
        ...
        return cls(
            ...
            cache_path=cache,
            writes_enabled=os.getenv("EOAT_ATLAS_WRITES_ENABLED", "false").strip().casefold()
            in {"1", "true", "yes", "on"},
            environment=os.getenv("EOAT_ATLAS_ENVIRONMENT", "production").strip().casefold(),

...
class AuditAction(StrEnum):
    ...
    DATA_PURGE_REQUEST = "DATA_PURGE_REQUEST"
...
_ACTION_CATEGORIES = {
    ...
    AuditAction.SESSION_REVOKED: AuditActionCategory.AUTHENTICATION,
    ...
    AuditAction.AUDIT_EXPORT: AuditActionCategory.EXPORTS,
    AuditAction.ADMIN_EXPORT: AuditActionCategory.EXPORTS,
    AuditAction.DIAGNOSTIC_RUN: AuditActionCategory.SYSTEM_OPERATIONS,
    AuditAction.INTEGRITY_SCAN: AuditActionCategory.SYSTEM_OPERATIONS,
    AuditAction.BACKUP_TRIGGERED: AuditActionCategory.SYSTEM_OPERATIONS,
    AuditAction.RESTORE_STARTED: AuditActionCategory.SYSTEM_OPERATIONS,
    AuditAction.RESTORE_COMPLETED: AuditActionCategory.SYSTEM_OPERATIONS,
    AuditAction.RESTORE_FAILED: AuditActionCategory.SYSTEM_OPERATIONS,
    AuditAction.FACTORY_RESET_REQUESTED: AuditActionCategory.DANGER_ZONE,
    AuditAction.DATA_PURGE_REQUEST: AuditActionCategory.DANGER_ZONE,
    AuditAction.DESTRUCTIVE_OPERATION: AuditActionCategory.DANGER_ZONE,

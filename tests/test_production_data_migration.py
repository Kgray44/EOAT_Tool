...
EXPECTED_TABLES = {
    ...
    "eoat_identity_aliases", "eoat_machine_compatibility", "eoat_storage_assignments",
...
def test_table_classification_is_complete_for_all_57_tables() -> None:
    assert len(EXPECTED_TABLES) == 57

...
PAGE_SPECS: tuple[PageSpec, ...] = (
    ...
    PageSpec(
        ...
        "Schedule",
        "Overview",
        "app.pages.schedule:SchedulePage",
        description="Project schedule and morning planning.",
    ),
    PageSpec(
        "audit",
        "EOAT Audit",
    ...
    PageSpec(
        ...
        "Data Import",
        "Capture",
        "app.pages.data_import:DataImportPage",
        description="Dry-run data import previews and local import staging.",
    ),
    PageSpec(
        "audit_progress",
        "Audit Progress",
    ...
    PageSpec(
        ...
        "Issues",
        "Analysis",
        "app.pages.issue_analysis:IssueAnalysisPage",
        description="Issue log analysis.",
    ),
    ...
    PageSpec(
        ...
        "Pilot Candidates",
        "Analysis",
        "app.pages.pilot_candidates:PilotCandidatesPage",
        description="Pilot candidate scoring.",
    ),
    PageSpec(
        "kpi_dashboard",
        "KPI Dashboard",
        "Analysis",
        "app.pages.kpi_dashboard:KpiDashboardPage",
    ...
    PageSpec(
        ...
        "Standards Docs",
        "Standards",
        "app.pages.standards_docs:StandardsDocsPage",
        description="Documentation gap reports.",
    ),
    PageSpec(
        "pm_checklists",
        "PM Checklists",
        "Standards",
        "app.pages.pm_checklists:PmChecklistsPage",
        description="PM checklist generation.",
    ),
    PageSpec(
        "bom_spares",
        "BOM / Spare Parts",
        "Standards",
        "app.pages.bom_spares:BomSparesPage",
        description="BOM and spare part analysis.",
    ),
    PageSpec(
        "reports",
        "Reports",
    ...
    PageSpec(
        ...
        "QR Labels",
        "Output",
        "app.pages.qr_labels:QrLabelsPage",
        description="Minimal EOAT machine and audit QR label values.",
    ),
    PageSpec(
        "handoff",
        "Final Handoff",
        "Output",
        "app.pages.handoff:HandoffPage",
        description="Final deliverable and handoff package tools.",
    ),
    PageSpec(
        "tool_registry",
        "Tool Registry",
        "System",
        "app.pages.tool_registry:ToolRegistryPage",

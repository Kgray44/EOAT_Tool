        ...
        self.main_layout.addWidget(
            CollapsibleSection.with_rows(
                ...
                (
                    ...
                    self._setting_row("Data source status", "Never reports cached data as a live server connection.", value_label(str(metrics.get("data_source_status") or ("Server connected" if metrics.get("api_online") else "Server unavailable")))),
                    ...
                    self._setting_row("Required API version", "", value_label(str(metrics.get("required_api_version") or EXPECTED_API_VERSION))),
                    ...
                    self._setting_row("Cached records", "", value_label(f"EOATs {counts.get('eoats', 0)} | Tools {counts.get('tools', 0)} | Machines {counts.get('machines', 0)}")),
                    self._setting_row("Last successful server refresh", "", value_label(str(metrics.get("last_successful_server_refresh") or metrics.get("last_successful_api_contact") or "Not recorded"))),

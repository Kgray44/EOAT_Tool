...
class MinimalistFitCheckContent(QWidget):
    ...
    def _generate_setup_packet_pdf(self, *, preview: bool) -> None:
        ...
        try:
            ...
            output_dir = Path(tempfile.gettempdir()) / "eoat_atlas_setup_packet_previews" if preview else final_dir
...
def _recent_fit_checks_path() -> Path:
    return writable_config_path("eoat_atlas_recent_fit_checks.json")

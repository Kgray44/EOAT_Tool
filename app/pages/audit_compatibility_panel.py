...
def build_compatibility_tab(page) -> QWidget:
    ...
    page.compatibility_source_combo.addItem("Loading Fit Check sources...", None)
    ...
    page.compatibility_note_label = QLabel("Loading Fit Check sources...")
    ...
    create = QPushButton("Create Selected Fit Check Entries")

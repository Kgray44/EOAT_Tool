...
| `admin.relationship.link` | `POST /api/v1/admin/data/relationships/{kind}` | `admin.relationship.manage` | Authoritative EOAT/Machine/Tool selectors; duplicate and compatibility validation | `LINK` | Idempotent key; selector/duplicate/rejection tests |

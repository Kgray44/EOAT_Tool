...
| ADM-DB-001 to 005 | Implemented / Deferred recovery evidence | Migrations 0005/0006, model constraints and indexes. Forward/rollback script exists; controlled real-MySQL execution remains environment-bound. |

...
It refuses a schema other than `20260717_0007`, refuses a production-named source, requires the reviewed 57-state distribution, uses UUIDv5 identifiers, and rejects mixed/partial row counts.

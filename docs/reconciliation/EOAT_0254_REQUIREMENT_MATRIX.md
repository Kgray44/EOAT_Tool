...
| Desktop/web parity | SOURCE_COMPARISON_COMPLETE; live visual gate blocked | `EOAT_0254_DESKTOP_WEB_PARITY_RECEIPT.md` | Controlled side-by-side session and difference register |

...
| --- | --- | --- | --- |
| Governed 0.25.4 source | PASS at source commit `b6265466ab` | Version checker, release history | Exact-head backend run still active |
...
| Desktop/web parity | IN_PROGRESS | Focused fixtures only | Controlled side-by-side session and difference register |

...
| R08 | Desktop/browser parity receipt | BLOCKED_EXTERNAL | `EOAT_0254_DESKTOP_WEB_PARITY_RECEIPT.md` | Source comparison complete; focused tests are not side-by-side proof | Documentation commit pending | Controlled visual session/difference register | No visual-equivalence claim |
...
| R15 | Final docs, commit, push, parity | IN_PROGRESS | reconciliation docs | Receipts prepared | Documentation commit pending | Commit/push/verify clean parity | Pending |

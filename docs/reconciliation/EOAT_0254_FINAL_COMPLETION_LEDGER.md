...
| R12 | Exact-head validation | NOT_STARTED | validation scripts | Focused tests only; do not treat as acceptance | - | Commit then run full backend/web/browser gates | Pending |

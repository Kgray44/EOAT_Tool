...
| R08 | Desktop/browser parity receipt | EXTERNALLY_BLOCKED | `EOAT_0254_DESKTOP_WEB_PARITY_RECEIPT.md` | 27 deterministic Qt/browser pairs captured and compared; reviewer disposition manifest absent | `b67d9d` evidence | Direct review/difference disposition for every state | No visual-equivalence claim |
...
| R10 | Capacity candidate readiness | EXTERNALLY_BLOCKED | migration tools, readiness receipt | 39 focused tests; historical candidate is older-source-bound | `445fcbd` | Fresh GET-only catalog and exact-source candidate/policy | No capacity imported |
